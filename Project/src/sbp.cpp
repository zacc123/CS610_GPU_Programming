...
void addSAT_dir(double ** SAT, double *BS, int Nx, double *HI, double mu){
    ...
    *SAT = (double *)malloc(size_SAT);
    ...
    memset(*SAT, 0.0, size_SAT);
    memset(Z, 0.0, size_SAT);
    memset(E0, 0.0, size_SAT);
    memset(EN, 0.0, size_SAT);
    memset(tmp, 0.0, size_SAT);

    double *tmp1 = (double *)malloc(size_SAT);
    memset(tmp1, 0.0, size_SAT);

    double *SAT1 = (double *)malloc(size_SAT);
    memset(SAT1, 0.0, size_SAT);
