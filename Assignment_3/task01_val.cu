...
#define M 1024// C Matrix Row Dim
#define N 1321// C Matrix Col Dim
#define K 2020 // Other dim for A and B Matrix (m, k) x (k x n)
...
int main(void) {
    ...
    */
    ...
    /*
    float *h_a1;
    cudaHostAlloc((void **)&h_a1, size_a, cudaHostAllocDefault);
    float *h_b1;
    cudaHostAlloc((void **)&h_b1, size_b, cudaHostAllocDefault);
    float *h_c1;
    cudaHostAlloc((void **)&h_c1, size_c, cudaHostAllocDefault);
    */
	...
	cudaFree(d_a1); cudaFree(d_b1); cudaFree(d_c1); cudaFree(d_a0); cudaFree(d_b0); cudaFree(d_c0);
